...
//写入数据库
function jinsom_add_im_one_img($author_id,$user_id,$content){
$time=current_time('mysql');
global $wpdb;
$table_name = $wpdb->prefix . 'jin_message';
$wpdb->query( "INSERT INTO $table_name (user_id,from_id,msg_content,msg_date,status) VALUES ('$author_id','$user_id','$content','$time',0)" );
}
