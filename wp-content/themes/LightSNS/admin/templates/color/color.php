...
if( ! class_exists( 'LightSNS_Field_color' ) ) {
class LightSNS_Field_color extends LightSNS_Fields {
...
echo '<input type="text" name="'. $this->field_name() .'" value="'. $this->value .'" class="jinsom-panel-color"'. $default_attr . $this->field_attributes() .'/>';
