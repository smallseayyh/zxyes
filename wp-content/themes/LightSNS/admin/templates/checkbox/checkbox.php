...
if( ! class_exists( 'LightSNS_Field_checkbox' ) ) {
class LightSNS_Field_checkbox extends LightSNS_Fields {
...
$inline_class = ( $args['inline'] ) ? ' class="jinsom-panel--inline-list"' : '';
...
echo '<label class="jinsom-panel-checkbox">';
echo '<input type="hidden" name="'. $this->field_name() .'" value="'. $this->value .'" class="jinsom-panel--input"'. $this->field_attributes() .'/>';
echo '<input type="checkbox" class="jinsom-panel--checkbox"'. checked( $this->value, 1, false ) .'/>';
