...
if( ! class_exists( 'LightSNS_Field_link_color' ) ) {
class LightSNS_Field_link_color extends LightSNS_Fields {
...
echo '<div class="jinsom-panel--title">'. ucfirst( $prop ) .'</div>';
echo '<input type="text" name="'. $this->field_name('['. $prop .']') .'" value="'. $value[$prop] .'" class="jinsom-panel-color"'. $default_attr . $this->field_attributes() .'/>';
echo '</div>';
