...
if( ! class_exists( 'LightSNS_Field_wp_editor' ) ) {
class LightSNS_Field_wp_editor extends LightSNS_Fields {
...
echo ( csf_wp_editor_api() ) ? '<div class="jinsom-panel-wp-editor" data-editor-settings="'. esc_attr( wp_json_encode( $editor_settings ) ) .'">' : '';
