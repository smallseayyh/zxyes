...
if( ! class_exists( 'LightSNS_Field_sortable' ) ) {
class LightSNS_Field_sortable extends LightSNS_Fields {
...
echo '<div class="jinsom-panel--sortable">';
...
echo '<div class="jinsom-panel--sortable-item">';

echo '<div class="jinsom-panel--sortable-content">';
...
LightSNS::field( $field, $field_value, $unique_id, 'field/sortable' );

echo '</div>';

echo '<div class="jinsom-panel--sortable-helper"><i class="fa fa-arrows"></i></div>';
