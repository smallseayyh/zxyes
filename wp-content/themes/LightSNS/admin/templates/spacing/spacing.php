...
if( ! class_exists( 'LightSNS_Field_spacing' ) ) {
class LightSNS_Field_spacing extends LightSNS_Fields {
...
echo ( ! empty( $args['all_text'] ) ) ? '<span class="jinsom-panel--label jinsom-panel--label-icon">'. $args['all_text'] .'</span>' : '';
