...
if( ! class_exists( 'LightSNS_Fields' ) ) {
abstract class LightSNS_Fields {
...
$output  = ( ! empty( $this->field['desc'] ) ) ? '<p class="jinsom-panel-text-desc">'. $this->field['desc'] .'</p>' : '';
$output .= ( ! empty( $this->field['after'] ) ) ? $this->field['after'] : '';
$output .= ( ! empty( $this->field['help'] ) ) ? '<span class="jinsom-panel-help"><span class="jinsom-panel-help-text">'. $this->field['help'] .'</span><span class="fa fa-question-circle"></span></span>' : '';
$output .= ( ! empty( $this->field['_error'] ) ) ? '<p class="jinsom-panel-text-error">'. $this->field['_error'] .'</p>' : '';
