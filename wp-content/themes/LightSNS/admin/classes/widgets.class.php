...
if( ! class_exists( 'LightSNS_Widget' ) ) {
class LightSNS_Widget extends WP_Widget {
...
echo '<div class="csf jinsom-panel-widgets jinsom-panel-fields'. $class .'">';
...
LightSNS::field( $field, $field_value, $field_unique );
