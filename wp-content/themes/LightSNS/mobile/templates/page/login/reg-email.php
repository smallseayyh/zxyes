...
?>
<div data-page="reg-email" class="page no-tabbar">
...
<div class="center sliding"><?php _e('邮箱注册','jinsom');?></div>
<div class="right">
...
<div class="jinsom-login-input-form jinsom-reg-mail">
<div class="jinsom-mobile-input">
<p class="name"><input type="text" placeholder="<?php _e('昵称','jinsom');?>"></p>
<p class="mail"><input type="text" placeholder="<?php _e('邮箱','jinsom');?>"></p>
<?php if(jinsom_get_option('jinsom_email_style')!='close'&&jinsom_get_option('jinsom_reg_email_code_on_off')){?>
<p class="code">
<input type="text" placeholder="<?php _e('验证码','jinsom');?>">

<?php if($jinsom_machine_verify_on_off&&in_array("code",$jinsom_machine_verify_use_for)){?>
<input class="jinsom-get-code jinsom-get-code-email" type="submit" value="<?php _e('获取验证码','jinsom');?>" id="code-2">
<?php }else{?>
<input class="jinsom-get-code jinsom-get-code-email" type="submit" value="<?php _e('获取验证码','jinsom');?>" onclick="jinsom_get_code(120,'email','','');">
<?php }?>
...
<?php }else{?>
<div class="jinsom-login-btn" onclick="jinsom_pop_reg_mail('','')"><?php _e('注册','jinsom');?></div>
<?php }?>
</div>
