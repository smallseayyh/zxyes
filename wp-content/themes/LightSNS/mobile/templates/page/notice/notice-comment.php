...
$notice_data = $wpdb->get_results("SELECT * FROM $table_name WHERE my_id = $user_id and notice_type ='comment' ORDER BY notice_time DESC LIMIT 30");
?>
<div data-page="comment-notice" class="page no-tabbar">
...
<div class="page-content jinsom-notice-tips-content comment">
...
//将消息标记为已读
$wpdb->query("UPDATE $table_name SET status = 1 WHERE my_id = $user_id and notice_type ='comment';");
}else{
echo jinsom_empty();
}
?>
