...
?>
<div data-page="outlay" class="page no-tabbar">
...
<div class="center sliding"><?php _e('支出记录','jinsom');?></div>
<div class="right">
...
<div class="jinsom-chat-user-list recharge-note list-block" page="2" type="cut">
<?php 
global $wpdb;
$table_name = $wpdb->prefix.'jin_credit_note';
$credit_data = $wpdb->get_results("SELECT * FROM $table_name WHERE  type='cut' and user_id='$user_id' ORDER BY time desc limit 20;");
if($credit_data){
...
<div class="item-after out">-'.$data->number.'</div>
</div>
</li>
';
}
