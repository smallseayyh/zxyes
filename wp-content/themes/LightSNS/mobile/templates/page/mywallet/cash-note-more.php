...
$ID=(int)$_GET['ID'];
?>
<div data-page="cash-note-more" class="page no-tabbar">
...
<div class="center sliding"><?php _e('提现详情','jinsom');?></div>
<div class="right">
...
<li><?php _e('提现金额','jinsom');?>：<?php echo $data->rmb;?><?php _e('元','jinsom');?></li>
