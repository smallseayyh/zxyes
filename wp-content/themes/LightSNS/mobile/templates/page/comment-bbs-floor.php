...
?>
<div data-page="comment-bbs-post-floor" class="page no-tabbar comment-bbs-floor">
...
<div class="center sliding"><?php _e('楼层回复','jinsom');?></div>
<div class="right">
...
<a class="link icon-only" id="comment-3"><?php _e('回复','jinsom');?></a>
<?php }else{?>
<a class="link icon-only" onclick="jinsom_bbs_comment_floor(<?php echo $comment_id;?>,<?php echo $post_id;?>,<?php echo $bbs_id;?>,'','')"><?php _e('回复','jinsom');?></a>
<?php }?>
...
<div class="page-content" id="jinsom-comment-page">
