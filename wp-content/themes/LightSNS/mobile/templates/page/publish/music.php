...
<a href="#" class="link icon-only" id="publish-music"><?php _e('发表','jinsom');?></a>
<?php }else{?>
<a href="#" class="link icon-only" onclick="jinsom_publish_music_video('music','','')"><?php _e('发表','jinsom');?></a>
<?php }?>
...
<div class="page-content jinsom-publish-words-form music">
...
<input type="text" id="jinsom-music-url" name="music-url" placeholder="<?php _e('音频地址：https://','jinsom');?>">
</form>



<div class="jinsom-publish-music-demo">
<form id="jinsom-upload-music-form" method="post" enctype="multipart/form-data" action="<?php echo get_template_directory_uri();?>/module/upload/music.php">
<div class="jinsom-upload-music-btn">
<div class="percent"></div>
<div class="center">
<i class="jinsom-icon jinsom-yinle"></i>
<p><?php _e('选择一个音频','jinsom');?></p>
</div>
</div>
<input id="jinsom-upload-music" type="file" name="file" accept="audio/*">
</form>
</div>
