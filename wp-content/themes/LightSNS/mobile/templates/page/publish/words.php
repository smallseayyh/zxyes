...
<a href="#" class="link icon-only" id="publish-words"><?php _e('发表','jinsom');?></a>
<?php }else{?>
<a href="#" class="link icon-only" onclick="jinsom_publish_words('','');"><?php _e('发表','jinsom');?></a>
<?php }?>
...
<div class="page-content jinsom-publish-words-form">
...
<input type="tel" name="price" class="price" placeholder="输入售价" style="display:none;margin-right:10vw;">
<input type="text" name="password" class="password" placeholder="输入密码" class="" maxlength="20" style="display:none;margin-right:10vw;">
<span class="img-power" style="display: none;"><i>前</i><input type="tel" name="power-see-img"><i>几张图片免费</i></span>
