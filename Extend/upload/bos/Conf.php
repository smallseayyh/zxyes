...
array(
'credentials' => array(
'accessKeyId' =>jinsom_get_option('jinsom_upload_bos_id'),
'secretAccessKey' =>jinsom_get_option('jinsom_upload_bos_key')
),
'endpoint' =>jinsom_get_option('jinsom_upload_bos_endpoint')
);
