...
$trade_no = $data['trade_order_id'];//商户订单号
...
//更新订单信息
$wpdb->query("UPDATE $table_name SET out_trade_no='$out_trade_no',status=$status,virtual_info='$virtual_info',pay_type='xunhupay',time='$time' WHERE trade_no = '$trade_no';");
