...
$mchid=$jinsom_pay_tab['jinsom_wechatpay_mchid'];
$appid=$jinsom_pay_tab['jinsom_wechatpay_appid'];
$appKey=$jinsom_pay_tab['jinsom_wechatpay_appkey'];
$apiKey=$jinsom_pay_tab['jinsom_wechatpay_apiKey'];

if(isset($_GET['trade_no'])){
$notifyUrl = home_url().'/Extend/pay/wechatpay/notify-goods.php';     //付款成功后的异步回调地址
...
$outTradeNo=$_GET['WIDout_trade_no'];
$payAmount=$_GET['WIDtotal_fee'];
$orderName=$_GET['WIDsubject'];
$notifyUrl=home_url().'/Extend/pay/wechatpay/notify.php';     //付款成功后的回调地址
}
$openId=$_GET['openid'];

//①、获取用户openid
$wxPay = new WxpayService($mchid,$appid,$appKey,$apiKey);
if(!$openId) wp_die('获取openid失败');
//②、统一下单
// $outTradeNo = $WIDout_trade_no;     //你自己的商品订单号
// $payAmount = $WIDtotal_fee;          //付款金额，单位:元
// $orderName = $WIDsubject;    //订单标题
$payTime = time();      //付款时间
...
<title><?php echo $WIDsubject;?></title>
