...
$outTradeNo=$_POST['WIDout_trade_no'];     //你自己的商品订单号
$payAmount=$_POST['number'];          //付款金额，单位:元
$orderName=$_POST['WIDsubject'];    //订单标题
$notifyUrl=home_url().'/Extend/pay/wechatpay/notify.php';     //付款成功后的回调地址(不要有问号)
}
...
$returnUrl = home_url();     //付款成功后，页面跳转的地址
$wapUrl = home_url();   //WAP网站URL地址
$wapName = jinsom_get_option('jinsom_site_name');       //WAP 网站名
/** 配置结束 */
